...
% simulates four datasets, one per scenario for Scenarios 1, 2, 3, and 4.
% Inputs:
%   sim_n: Command line argument indicating array index
% Outputs: saves simulated datasets corresponding to Scenarios 1-4.
function sim_equal_subpop(sim_n)
    rng(sim_n)                                     % Set seed
