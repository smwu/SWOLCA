% wtd_run_MCMC_latent runs the Gibbs Sampler MCMC algorithm to obtain posteriors
...
function [MCMC_out, OFMM_params, probit_params] = wtd_run_MCMC_latent(data_vars, OFMM_params, probit_params, n_runs, burn, thin, k_max, q_dem, p_cov, alpha, eta, mu_0, Sig_0, S)
    ...
    for iter = 1:n_runs  % For each MCMC run
        ...
        [MCMC_out, OFMM_params, probit_params] = wtd_update_MCMC_latent(MCMC_out, data_vars, OFMM_params, probit_params, thin, k_max, q_dem, alpha, eta, mu_0, Sig_0, iter, S);
