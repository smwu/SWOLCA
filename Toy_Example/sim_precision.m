...
% There are 2 global latent classes, generated independently of 
% subpopulation membership. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%54%%%%%%%%%%%%%%

% sim_precision takes in sim_n as a command line array index argument, and 
...
function sim_precision(sim_n)
    ...
    sim_data.true_pi = [0.5, 0.5];                % Global class membership proportions
