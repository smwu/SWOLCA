% get_data_vars_latent takes in sample data and outputs relevant variables for the
% sOFMM model with the latent variable formulation
...
function data_vars = get_data_vars_latent(samp_data)
