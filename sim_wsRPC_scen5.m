...
% Programmer: SW                                              %
% Scenario 5: Unequal subpop sizes                            %
%             Sample 1000 from each subpop (equal allocation) %
...
for sim_n = 1:num_sims                     % For each simulation iteration
    ...
    N_s = [10000, 25000, 27500, 17500]; % Subpop sizes
    n_s = [1000, 1000, 1000, 1000];     % Sampled subpop sizes
