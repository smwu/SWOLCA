...
% sim_uneq_pi_extreme takes in sim_n as a command line array index argument, 
...
function sim_uneq_pi_extreme(sim_n)
    ...
    sim_data.true_pi = [0.7 0.2 0.1;                 % Subpop-specific global class membership probs
                        0.2 0.1 0.7;
                        0.1 0.7 0.2;
                        0.33 0.33 0.34];        
