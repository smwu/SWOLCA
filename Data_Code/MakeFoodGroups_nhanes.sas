...
* RUN THIS SECTION IF YEAR IS 1718. IF YEAR IS 1516, RUN ALTERNATIVE CODE BELOW INSTEAD;
data day1;
	set adultdata1;
...
*USE THIS INSTEAD IF YEAR IS 1516;
data day1;
	set adultdata1;

array drf {37} DR1T_F_CITMLB--DR1T_A_DRINKS; *CHECK THE ORDER OF FOODS FROM CONTENTS;
array foodgroup {37} foodgroup4 foodgroup1 foodgroup2 foodgroup3 foodgroup13 foodgroup5 foodgroup8 foodgroup6 foodgroup7
foodgroup11 foodgroup9 foodgroup10 foodgroup12 foodgroup14 foodgroup17 foodgroup15 foodgroup16 foodgroup29 foodgroup24
foodgroup18 foodgroup19 foodgroup20 foodgroup21 foodgroup22 foodgroup23 foodgroup25 foodgroup26 foodgroup27 foodgroup28
foodgroup33 foodgroup30 foodgroup31 foodgroup32 foodgroup34 foodgroup35 foodgroup36 foodgroup37;
	do i=1 to 37;
		foodgroup{i}=drf{i};
	end;

	drop i DR1T_F_CITMLB--DR1T_A_DRINKS;
run; 
data day2;
	set adultdata2;

array drf {37} DR2T_F_CITMLB--DR2T_A_DRINKS; *CHECK THE ORDER OF FOODS FROM CONTENTS;
array foodgroup {37} foodgroup4 foodgroup1 foodgroup2 foodgroup3 foodgroup13 foodgroup5 foodgroup8 foodgroup6 foodgroup7
foodgroup11 foodgroup9 foodgroup10 foodgroup12 foodgroup14 foodgroup17 foodgroup15 foodgroup16 foodgroup29 foodgroup24
foodgroup18 foodgroup19 foodgroup20 foodgroup21 foodgroup22 foodgroup23 foodgroup25 foodgroup26 foodgroup27 foodgroup28
foodgroup33 foodgroup30 foodgroup31 foodgroup32 foodgroup34 foodgroup35 foodgroup36 foodgroup37;
	...
	drop i DR2T_F_CITMLB--DR2T_A_DRINKS;
run; 
