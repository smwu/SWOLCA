% wtd_unsup_run_MCMC_latent runs the Gibbs Sampler MCMC algorithm to obtain 
...
function [MCMC_out, OFMM_params] = wtd_unsup_run_MCMC_latent(data_vars, OFMM_params, n_runs, burn, thin, k_max, alpha, eta)
