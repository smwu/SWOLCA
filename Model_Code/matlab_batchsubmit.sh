#!/bin/bash
#SBATCH -J SRS_scen101_102_wsOFMM	# Job name for the array
#SBATCH -o SRS_scen101_102_wsOFMM%A.out  # Shared standard output with job ID
#SBATCH -e SRS_scen101_102_wsOFMM%A.err  # Shared standard error with job ID
