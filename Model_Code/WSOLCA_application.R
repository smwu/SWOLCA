...
# 'WSOLCA_app_Rcpp' runs the WSOLCA model and saves and returns results
# Inputs:
...
WSOLCA_app_Rcpp <- function(data_path, res_path, adj_path, stan_path, 
