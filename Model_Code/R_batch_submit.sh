#!/bin/bash
#SBATCH -J Rcpp_WOLCA_effmod_scen111211_        # Job name for the array
#SBATCH -o Rcpp_WOLCA_effmod_scen111211_%A.out  # Shared standard output with job ID
#SBATCH -e Rcpp_WOLCA_effmod_scen111211_%A.err  # Shared standard error with job ID
