#!/bin/bash
#SBATCH -J Rcpp_WSOLCA_scen121111_        # Job name for the array
#SBATCH -o Rcpp_WSOLCA_scen121111_%A.out  # Shared standard output with job ID
#SBATCH -e Rcpp_WSOLCA_scen121111_%A.err  # Shared standard error with job ID
