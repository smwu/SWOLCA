#!/bin/bash
#SBATCH -J Rcpp_WOLCA_scen112111_        # Job name for the array
#SBATCH -o Rcpp_WOLCA_scen112111_%A.out  # Shared standard output with job ID
#SBATCH -e Rcpp_WOLCA_scen112111_%A.err  # Shared standard error with job ID
