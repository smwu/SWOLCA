#!/bin/bash
#SBATCH -J Rcpp_WSOLCA_effmod_scen112211_        # Job name for the array
#SBATCH -o Rcpp_WSOLCA_effmod_scen112211_%A.out  # Shared standard output with job ID
#SBATCH -e Rcpp_WSOLCA_effmod_scen112211_%A.err  # Shared standard error with job ID
