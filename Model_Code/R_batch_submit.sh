#!/bin/bash
#SBATCH -J Rcpp_SOLCAOLD25000_scen202_        # Job name for the array
#SBATCH -o Rcpp_SOLCAOLD25000_scen202_%A.out  # Shared standard output with job ID
#SBATCH -e Rcpp_SOLCAOLD25000_scen202_%A.err  # Shared standard error with job ID
#SBATCH -p shared      # Partition to submit to
#SBATCH -n 1	       # Number of cores
#SBATCH -t 0-06:00:00  # Runtime (D-HH:MM:SS)
