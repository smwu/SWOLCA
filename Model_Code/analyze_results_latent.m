...
function analysis = analyze_results_latent(post_MCMC_out, data_vars, q_dem, S, p_cov)
    ...
    Q = [q_dem dummyvar(post_MCMC_out.c_i)];    % Design matrix with demographic covariates and updated latent classes
