...
% wsOFMM takes in scenario as a command line scenario index argument and 
% sim_n as a command line array index argument. It reads in the simulated 
% dataset corresponding to the given array and scenario, runs the wsOFMM 
...
function wsOFMM_main(scenario, sim_n, samp_n)
    % set seed
    rng(sim_n, 'twister');
